  ...
  return (
    <main className="plain-surface container" style={{ padding: '72px 32px', maxWidth: 680 }}>
      ...
      <section style={{ marginBottom: 28 }}>
        ...
        <p style={{ color: 'var(--slate)', fontSize: 15, lineHeight: 1.8 }}>
          Lowers the platform fee to 10%, adds priority placement and a Pro badge.
        </p>
      </section>
      ...
      <section style={{ marginBottom: 40 }}>
        ...
        <p style={{ color: 'var(--slate)', fontSize: 15, lineHeight: 1.8 }}>
          Built for freelancers regularly taking on higher-value federal contract work, where a flat 15% adds up fast.
        </p>
      </section>
      ...
      <section style={{ marginBottom: 28 }}>
        ...
        <p style={{ color: 'var(--slate)', fontSize: 15, lineHeight: 1.8 }}>
          Added on top of the invoice when you hire and pay a freelancer through LanceNest.
        </p>
      </section>
